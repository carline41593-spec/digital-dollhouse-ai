  ...
  const generate = async () => {
    ...
    try {
      const res = await fetch("/api/photoshoot", {
        ...
        body: JSON.stringify({ image_base64: face.split(",")[1], prompt: prompt.trim() }),
      });
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12">
        <div className="space-y-8">
          ...
          <textarea
            ...
            placeholder="e.g. blonde hair, red dress, beach sunset, luxury fashion model..."
        ...
        <div className="grid grid-cols-2 gap-6">
          {loading && <div className="col-span-2 text-center text-4xl animate-pulse">Creating magic...</div>}
          {images.map((url, i) => (
