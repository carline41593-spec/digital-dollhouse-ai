...
export async function POST(request: Request) {
  try {
    ...
    // Build multimodal content (main image + optional reference + prompt)
    const content = [
      { type: 'text', text: `Keep this exact person's face, identity, skin tone, and features. Only change: ${prompt}. Photorealistic, 8k, professional lighting, ultra detailed skin.` },
