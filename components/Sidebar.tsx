...
export default function Sidebar() {
  ...
  return (
    <div className="fixed inset-y-0 left-0 w-80 bg-black/90 backdrop-blur-2xl border-r border-pink-500/20 z-50 flex flex-col">
      {/* Logo */}
      <div className="p-10 text-center border-b border-pink-500/20">
        <h1 className="text-5xl font-black bg-gradient-to-r from-pink-400 via-yellow-400 to-pink-400 bg-clip-text text-transparent">
          DigitalDollhouse
        </h1>
        <p className="text-pink-300 text-lg mt-2">Creator AI Suite</p>
      </div>
      ...
      {/* Copyright – pinned to bottom, never blocks anything */}
